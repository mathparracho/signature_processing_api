...
def plotar_vetores_paradig(vetor1, vetor2, titulo="Gráfico de Vetores", label1="Vetor 1", label2="Vetor 2"):
    ...
    plt.plot(vetor2, 'bo', label=label2, markersize=8)  # 'bo' significa blue (azul), circles (o)
